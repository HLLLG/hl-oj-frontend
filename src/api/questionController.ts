...
/** 此处后端没有提供注释 POST /question/export */
export async function exportQuestions(
  body: API.QuestionQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseListQuestion>('/question/export', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getQuestionById(
  ...
  return request<API.BaseResponseQuestion>('/question/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** 此处后端没有提供注释 POST /question/import */
export async function importQuestions(
  body: API.QuestionAddRequest[],
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseInteger>('/question/import', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listQuestionSubmitVoByPage(
  ...
  return request<API.BaseResponsePageQuestionSubmitVO>('/question/question_submit/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
